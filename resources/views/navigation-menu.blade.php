<nav class="flex items-center justify-between py-3 px-6 border-b border-gray-100">
    <div id="nav-left" class="flex items-center">
        ...
        <div class="top-menu ml-10">
            <div class="flex space-x-4">
                ...
                <x-nav-link href="{{ route('blogs.blog') }}" :active="request()->routeIs('blogs.blog')" iconClass="fas fa-blog"
                    class="text-sm text-gray-500 hover:text-gray-700 transition duration-300">
                    {{ __('Blog') }}
                </x-nav-link>
    ...
    <div id="nav-right" class="flex items-center md:space-x-6">
        ...
        @auth
            @if (auth()->user()->role === App\Models\User::admin || auth()->user()->role === App\Models\User::author)
